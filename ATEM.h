...
class ATEM
{
  private:
	...
	boolean _ATEM_FtbS_state;       // State of Fade To Black, 0 = off and 1 = in transition
	boolean _ATEM_FtbS_active;      // State of Fade To Black, 0 = off and 1 = activated
